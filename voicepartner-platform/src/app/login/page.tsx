...
export default function LoginPage() {
  const [email, setEmail] = useState('demo@voicepartnerai.com')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Nach erfolgreichem Login zum Workspace weiterleiten
        ...
        <div className="bg-card rounded-lg shadow-lg border border-border p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground mt-2">
              Melden Sie sich in Ihrem VoicePartnerAI Konto an
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  disabled={loading}
                  required
                  className="w-full px-3 py-2 border border-input bg-background rounded-md focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent pr-10"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="w-full bg-accent hover:bg-accent/90 text-accent-foreground py-2 px-4 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="mt-6 p-4 rounded-md bg-primary/5 border border-primary/20">
            <h4 className="text-sm font-medium text-foreground mb-2">
              Demo-Zugang (bereits eingegeben):
            </h4>
            <p className="text-xs text-muted-foreground">
              E-Mail: demo@voicepartnerai.com<br />
              Passwort: password
            </p>
          </div>
        </div>
